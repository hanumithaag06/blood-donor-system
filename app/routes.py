...
from app.schemas import (
    ...
    DonationCreateSchema, DonationResponseSchema,
    SearchQuerySchema, AssistantQuerySchema,
...
def search_donors():
    query = SearchQuerySchema(
        ...
        available_only=request.args.get("available_only", "").lower() == "true" or None,
    )
    with get_session() as session:
        ...
        # NEW: rank by eligible -> available -> ML prediction, reusing PredictionService
